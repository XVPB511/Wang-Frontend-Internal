    ...
    ui: {
      table: {
        slots: {
          ...
          tr: 'data-[selected=true]:bg-(--ui-bg-elevated)/50 odd:bg-white even:bg-gray-200 border border-gray-50',
          th: 'px-4 py-3.5 text-sm text-(--ui-text-highlighted) text-left rtl:text-right font-semibold [&:has([role=checkbox])]:pe-0 text-black border border-gray-50',
