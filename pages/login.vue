    ...
    <div class="w-full max-w-sm p-6 bg-white rounded-lg shadow-md">
      ...
      <form @submit.prevent="handleLogin">
        <div class="mb-4">
          ...
          <input
            v-model="email"
            class="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring focus:border-blue-300 text-black"
            required
          />
        </div>
        <div class="mb-6">
...
const email = ref("janelee925");
const password = ref("secureP@ss123");
